...
class IntegrationProviderClient:
    ...
    def create_user_integration_provider_connection(self, providerId: str) -> AstroResult[ConnectionSchemaDto]:
        """
    ...
    def update_user_integration_provider_connection(self, providerId: str, body: AuthenticationDto) -> AstroResult[object]:
        """
        Allows you to update the auth status of the provider specific
