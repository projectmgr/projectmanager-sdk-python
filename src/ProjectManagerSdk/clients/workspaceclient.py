...
class WorkSpaceClient:
    ...
    def retrieve_the_current_workspace(self) -> AstroResult[List[WorkSpaceDto]]:
        """
    ...
    def update_settings_for_the_current_workspace(self, body: WorkspaceSettingsUpdateDto) -> AstroResult[WorkSpaceDto]:
        """
