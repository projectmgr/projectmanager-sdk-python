...
class ProjectManagerClient:
    ...
    def __init__(self, env: str, appname: str):
        ...
        from ProjectManagerSdk.clients.meetingrecurrencyclient import MeetingRecurrencyClient
        ...
        self.meetingRecurrency = MeetingRecurrencyClient(self)
        ...
        self.taskRecurrency = TaskRecurrencyClient(self)
        self.taskStatus = TaskStatusClient(self)
        self.taskTag = TaskTagClient(self)
        self.taskTodo = TaskTodoClient(self)
