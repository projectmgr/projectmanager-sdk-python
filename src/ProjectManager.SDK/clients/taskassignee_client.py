...
from ProjectManager.SDK.models.assigneeupsertdto import AssigneeUpsertDto
from ProjectManager.SDK.models.changesetstatusdto import ChangeSetStatusDto
from ProjectManager.SDK.models.iddto import IdDto
...
class TaskAssigneeClient:
    ...
    def replace_task_assignees(self, taskId: str, body: list[object]) -> AstroResult[AstroResult[ChangeSetStatusDto]]:
        """
    ...
    def create_or_update_taskassignee(self, taskId: str, body: list[object]) -> AstroResult[AstroResult[ChangeSetStatusDto]]:
        """
    ...
    def delete_task_assignees(self, taskId: str, body: list[object]) -> AstroResult[AstroResult[ChangeSetStatusDto]]:
        """
