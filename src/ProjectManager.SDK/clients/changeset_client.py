...
from ProjectManager.SDK.models.changesetgetresponsedto import ChangesetGetResponseDto
...
class ChangesetClient:
    ...
    def retrieve_changeset(self, changeSetId: str) -> AstroResult[AstroResult[ChangesetGetResponseDto]]:
        """
        ...
        if result.status_code >= 200 and result.status_code < 300:
            return AstroResult(True, result.status_code, AstroResult.from_json(result.json(), ChangesetGetResponseDto), None)
        else:
            return AstroResult(False, result.status_code, None, ErrorResult.from_json(result.json()))

    def retrieve_completed_changeset(self, changeSetId: str) -> AstroResult[AstroResult[ChangesetGetResponseDto]]:
        """
