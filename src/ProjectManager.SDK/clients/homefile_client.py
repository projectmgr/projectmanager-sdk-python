...
class HomeFileClient:
    ...
    def upload_home_file(self, filename: str) -> AstroResult[AstroResult[FileDto]]:
        """
    ...
    def upload_home_file_to_folder(self, folderId: str, filename: str) -> AstroResult[AstroResult[FileDto]]:
        """
        Uploads a file to a home folder.
